...
4) MAIN HEADLINE at ~18-34% from top: THREE-line stacked text, tightly stacked, generous letterspacing, warm-gold glow halo:
   Line 1: "MEMBERS"
   Line 2: "ONLY"
   Line 3: "GIVEAWAY"
...
const jobs = [
  {
    ...
    _meta: { name: "muha-members-only-giveaway" },
  },
];

fs.writeFileSync("muha-members-only-giveaway.json", JSON.stringify(jobs, null, 2));
