...
- USE THESE NORMALIZED COORDINATES (origin = top-left, values are fractions of the full canvas width/height as [x, y, w, h]) AS HARD POSITIONS. Each element must land in its box, at its size. Do not nudge:
  ...
  4. TOP EMBLEM = MUHA MEMBERS logo ALONE, single and CENTERED — [0.30, 0.11, 0.40, 0.10]. Turquoise/blue checkmark "M" badge + gold "M" monogram + gold cursive "Members" lettering, pixel-faithful to the reference logo. This is the ONLY emblem in the top banner row, flanked just by the two corner eagle crests.
...
console.log("Generating Master Case v10 FRONT (Muha Members logo alone up top, MM coin at bottom)...");
...
const outPath = `${outDir}/${stamp}_muha-mastercase-v10-FRONT.png`;
