...
CONTENT (keep it minimal — this side is mostly a BACKGROUND that flavor badges get added onto later):
  1. TOP LOGO ZONE — LEAVE IT BLANK: do NOT place any logo, emblem, badge, monogram, or "Members" wordmark near the top. Leave clean empty negative space there because the real Muha Members logo will be dropped in by the designer later.
  ...
  3. A small MM emblem / winged-M coin accent low-center (re-skin of image 0's small emblem), modest. (This is fine to render — it is NOT the Members logo.)
...
NEGATIVE: do NOT fill the blank central area with artwork — keep it open for badges. Keep the TOP logo zone BLANK (no Members logo/emblem/wordmark there — reserved for later drop-in). Do NOT add cartoon characters, fruit, or the truck. Do NOT add "MUHA MEMBERS"/"MUHA"/"Members"/"Von Dutch" text. Do NOT use the black chrome Von-Dutch style. Do NOT change the panel shape/proportions. No phone numbers/URLs/barcodes. No misspellings.`;
...
const outPath = `${outDir}/${stamp}_muha-mastercase-v13-SIDE.png`;
