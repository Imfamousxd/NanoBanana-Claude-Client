...
4) MAIN HEADLINE at ~20-34% from top: THREE-line stacked text, tightly stacked, generous letterspacing, warm-gold glow halo:
   ...
   Line 2: "WINNER"
   Line 3: "COULD BE YOU"
   All three lines the SAME font size and weight — uniform, bold, commanding. No size variation between lines.
...
5) CINEMATIC HERO ZONE at ~38-72% from top: A dramatic, atmospheric scene — a red Dodge Challenger bathed in red neon glow on a wet Miami night street, palm trees overhead, atmospheric haze and city lights in the distance. A pair of car keys with a Dodge keychain dangles in the foreground, slightly out of focus, held by a shadowy hand. The whole scene feels like a Vice City cinematic cutscene — moody, aspirational, dripping with lifestyle energy. Warm red and gold light reflections on the wet pavement. The car is angled 3/4 view, hero-lit from the left. NO raffle ticket, NO card, NO QR code in this zone — just the car, the keys, and the Vice City atmosphere.
...
Negative: do not use slab serif or traditional letterpress display font on the main headline, do NOT make headline lines different sizes, do not include any raffle ticket or card graphic anywhere in the image, do not include any QR code, do not lighten the background, do not omit the red Miami glow / palm silhouettes, do not warp the MM logo, do not show any faces, no extra logos.`;
...
const jobs = [
  {
    ...
    _meta: { name: "muha-could-be-you-v4" },
  },
];

fs.writeFileSync("muha-could-be-you-v4.json", JSON.stringify(jobs, null, 2));
